...
export default function Home() {
  ...
  const loadData = async () => {
    let response = await fetch("http://13.232.16.81:5000/api/foodData", {
      method: "POST",
      headers: {
      ...
      <div>
        ...
        <div><div id="carouselExampleFade" className="carousel slide carousel-fade" data-bs-ride="carousel" style={{ objectFit: "contain !important" }}>
          ...
          <div className="carousel-inner" id='carousel'>
            ...
            <div className="carousel-item">
              <img src="https://source.unsplash.com/random/900×700/?friedrice" className="d-block w-100" style={{ filter: "brightness(30%)" }} alt="..." />
            </div>
          </div>
              ...
              <div key={data._id} className='row mb-3'>
                ...
                {foodItem.length !== 0 ? (
                  foodItem
                    ...
                    .map((filterItems) => (
                      <div key={filterItems._id} className='col-16 col-md-8 col-lg-4'>
                        <Card
